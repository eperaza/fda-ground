...
public class FileManagementService {
    ...
    public String getTspContainerFromStorage(String authToken) throws FileDownloadException, IOException {
    ...
    public List<OnsCertificate> getOnsCertInfo(String authToken) throws OnsCertificateException {
        ...
        try {
            ...
            String file = "unknown";
            String role = "na";
            if (userRole.equalsIgnoreCase("airlinepilot")) {
                role = "fc";
                file = "fc_exp2022_04_15.pfx";
            }
            if (userRole.equalsIgnoreCase("airlinefocal")) {
                role = "fc";
                file = "fc_exp2022_04_15.pfx";
            }
            if (userRole.equalsIgnoreCase("airlineefbadmin")) {
                role = "fc";
                file = "fc_exp2022_04_15.pfx";
            }
            if (userRole.equalsIgnoreCase("airlinemaintenance")) {
                role = "mc";
                file = "mc_exp2022_04_14.pfx";
            }
            if (userRole.equalsIgnoreCase("airlinecheckairman")) {
                role = "mc";
                file = "mc_exp2022_04_14.pfx";
            }
